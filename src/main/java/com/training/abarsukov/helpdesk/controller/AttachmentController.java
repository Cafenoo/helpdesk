...
public class AttachmentController {
  ...
  public ResponseEntity<AttachmentDto> getAttachment(@PathVariable Long ticketId) {
  ...
  public ResponseEntity<Void> createAttachment(
      @PathVariable Long ticketId, @Valid @ModelAttribute AttachmentDto attachmentDto) {
    attachmentService.save(ticketId, attachmentDto);
    return ResponseEntity.created(URI.create("/tickets/" + ticketId + "/attachments/")).build();
  }
