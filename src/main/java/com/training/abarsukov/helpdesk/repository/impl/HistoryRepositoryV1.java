...
@Repository
public class HistoryRepositoryV1 extends AbstractRepository<History, Long>
  ...
  private static final String REVERSE_ORDER = " order by h.id desc";
  ...
  public List<History> findByTicketId(Long ticketId, boolean doGetAll, User user) {
    ...
    final Map<Boolean, Supplier<List<History>>> repositoryMethodsMap =
        Map.of(
    ...
    return repositoryMethodsMap.get(doGetAll).get();
  }
}
