...
@Repository
public class CommentRepositoryV1 extends AbstractRepository<Comment, Long>
  ...
  private static final String REVERSE_ORDER = " order by c.id desc";
  ...
  public List<Comment> findByTicketId(Long ticketId, boolean doGetAll, User user) {
    ...
    Map<Boolean, Supplier<List<Comment>>> repositoryMethodsMap =
        Map.of(
